...
const Features = () => {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,_#F0E0E7_0%,_#525EE2_100%)]">
      <Navigation />
      <div className="container mx-auto px-4 mt-16 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Paideia combines cutting-edge AI technology with expert human
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {mainFeatures.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className={`bg-white rounded-xl p-8 shadow-lg hover:shadow-2xl transition-all border-2 ${colors.border}`}
              >
