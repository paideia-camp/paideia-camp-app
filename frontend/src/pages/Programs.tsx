...
const programs = [
  {
    ...
    region: "Africa",
    description:
      "Leadership training program for young African leaders in business, civic engagement, and public management.",
  ...
  },
  {
    ...
    description:
      "UK government global scholarship programme for future leaders to pursue one-year master's degree.",
    eligibility: [
      "Bachelor degree",
      "Work experience",
  ...
  },
  {
    ...
    region: "Africa",
    description:
      "Entrepreneurship program providing training, funding, and mentoring to African entrepreneurs.",
    eligibility: [
  ...
  },
  {
    ...
    description:
      "Leadership training in business, civic leadership, or public management for young African leaders.",
  ...
  },
  {
    ...
    region: "United Kingdom",
    description:
      "Oldest international scholarship programme for postgraduate study at the University of Oxford.",
    eligibility: [
...
export default function Programs() {
  ...
  const filteredPrograms = programs.filter((program) => {
    ...
    const matchesRegion =
      regionFilter === "all" || program.region === regionFilter;
