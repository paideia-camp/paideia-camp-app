  ...
  const testimonials = [
    {
      ...
      message:
        "Paideia helped me articulate my impact story in a way that resonate with the YALI selection committee. Now I'm part of their 2026 cohort!",
    },
    {
      name: "Emmanuel Kwame",
      role: "Policy Analyst",
    ...
    },
    {
      ...
      role: "Student",
      message:
        "Thanks to Paideia, I secured a full scholarship for my master's program abroad after taking an assessment.",
    },
    {
      name: "Maria Garcia",
      role: "Researcher",
    ...
    },
    {
      ...
      role: "Designer",
      message:
        "Paideia's micro-courses boosted my confidence and leadership skills immensely.",
    },
    {
      name: "Sarah Wilson",
      role: "Consultant",
    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,_#F0E0E7_0%,_#525EE2_100%)] overflow-hidden">
          ...
          <div className="relative z-10 flex items-center justify-center min-h-screen px-10 md:px-5 py-5">
            <div className="text-center space-y-8 text-white px-4">
              ...
              <p className="text-xl text-black max-w-2xl mx-auto">
                ...
                scholarships, and accelerators. Join the CAMP Readiness Engine
        ...
        <div className="flex flex-col lg:flex-row gap-20 justify-center items-center">
          ...
          >
            <CardHeader>
              ...
              <CardDescription className="py-5 text-base">
                African innovators struggle with opportunity readiness,
          ...
          >
            <CardHeader>
              ...
              <CardDescription className="py-5 text-base">
                Paideia diagnoses weaknesses, align skills with real criteria,
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            >
              ...
              <div className="text-center">
                <strong>Login via camp</strong>
                <p>Sign in seamlessly through the login page</p>
              </div>
            </div>
          </div>
      ...
      <div className="container px-4 py-20 mx-auto max-w-7xl">
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-lg max-w-2xl mx-auto">
            See how Paideia has helped African Innovators achieve their goals
          </p>
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 items-center justify-center gap-5 py-5">
            ...
            <div>
              ...
              <div className="text-center ">African innovators supported</div>
            </div>
            <div>
              <div className="text-white font-semibold text-xl text-center">
                90%
      ...
      <div className="bg-[linear-gradient(90deg,_#007BFF_0%,_#3728A7_100%)] z-20 relative">
        <div className="text-white py-28 px-5 text-center block">
          ...
          <p className="py-5">
            Join thousands of African innovators who are accelerating their
            careers and making global impact with Paideia.
          </p>
