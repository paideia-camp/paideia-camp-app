    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,_#F0E0E7_0%,_#525EE2_100%)]">
      ...
      <div className="container mx-auto px-4 mt-20 py-20">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold mb-6">About Paideia</h1>
        ...
        <Card className="mb-16 border-2">
          ...
          <CardContent className="space-y-4 text-gray-700 leading-relaxed">
            <p>
              Paideia was born from a simple observation: talented African youth
            ...
            <p>
              Today, Paideia combines cutting-edge AI technology with human
