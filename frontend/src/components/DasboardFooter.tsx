...
const DashboardFooter = () => {
  ...
  const contact = [
    { dot: DotIcon, name: "Email: info@paidela.afrcia" },
    { dot: DotIcon, label: "CAMP NETWORK HQ" },
    { dot: DotIcon, label: "Lagos Nigeria" },
  ];
  return (
    <div>
      <div className="bg-[#171127] text-white w-full static left-0 right-0 bottom-0">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 py-10 md:py-14 lg:py-20 px-4 md:px-10 lg:px-10 justify-center">
          <div className="my-4">
            ...
            <div className="py-4 mb-4 px-4">
              Your AI Powered Talent Readiness Engine for African Investors in
              the Camp Network
            </div>
        ...
        <div className=" text-center py-6 px-4">
          &copy; 2025 Paidela - CAMP Network Africa.{" "}
